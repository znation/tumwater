/** Second slice of the orchestrator e2e suite (orchestrator.test.ts is the first,
 * orchestrator-3.test.ts the third) — split so node --test runs the slices in parallel
